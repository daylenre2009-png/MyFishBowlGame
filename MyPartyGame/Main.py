...
GAME_DATA_POOLS = {
    ...
    "actions": [
        "Harry Potter", "Stranger Things", "The Lion King", "Spider-Man", "Star Wars",
        "Wednesday", "Titanic", "Spongebob Squarepants", "Frozen", "Jurassic Park"
    ],
    "categories": [
